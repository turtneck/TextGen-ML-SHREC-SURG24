...
#NOTE: TRAINING-------------------------
print( f"SIZE1: {csv_size('prompt/1M-GPT4-Augmented_edit-256-2.csv')}" )
print( f"SIZE2: {csv_size('prompt/3_5M-GPT3_5-Augmented_edit-256-2.csv')}" )
print( f"SIZE3: {csv_size('prompt/MovieSorted-256-3.csv')}" )
# input("Ready?")

MODEL.train_model_prompt2(
    dir_path="prompt/1M-GPT4-Augmented_edit-256-2.csv",
...
MODEL.train_model_prompt2(
    dir_path="prompt/3_5M-GPT3_5-Augmented_edit-256-2.csv",
    savepath=f"Models/PyTorch_v{VERSION}/SFT-type1/",
    logpath=f'Model_Log/PyTorch/Prompts/PTv{VERSION}_SFT-type1.txt',
    save_iter=1600,
    end=16000
...
MODEL.train_model_prompt2(
    dir_path="prompt/MovieSorted-256-3.csv",
    savepath=f"Models/PyTorch_v{VERSION}/SFT-type1/",
    logpath=f'Model_Log/PyTorch/Prompts/PTv{VERSION}_SFT-type1.txt',
    save_iter=1600,
    end=16000
